# Awesome GitHub Cheat Sheet with stars
...
If you go to the repo's [Branches](https://github.com/tiimgreen/github-cheat-sheet/branches) ⭐ 58,497 | 🐛 48 | 📅 2024-04-15 page, next to the Commits button:
...
[![Travis CI status](https://cloud.githubusercontent.com/assets/1687642/2700187/3a88838c-c410-11e3-9a46-e65e2a0458cd.png)](https://github.com/octokit/octokit.rb/pull/452) ⭐ 3,948 | 🐛 33 | 🌐 Ruby | 📅 2026-06-22
...
For the Rails repo: <https://github.com/rails/rails/issues> ⭐ 58,690 | 🐛 1,586 | 🌐 Ruby | 📅 2026-08-14, the following filter is built by selecting the label "activerecord":
...
GitHub uses [Linguist](https://github.com/github/linguist) ⭐ 13,641 | 🐛 227 | 🌐 Ruby | 📅 2026-08-12 to perform language detection and syntax highlighting. You can find out which keywords are valid by perusing the [languages YAML file](https://github.com/github/linguist/blob/master/lib/linguist/languages.yml) ⭐ 13,641 | 🐛 227 | 🌐 Ruby | 📅 2026-08-12.
...
The full list of supported Emojis on GitHub can be found at [emoji-cheat-sheet.com](http://www.emoji-cheat-sheet.com/) or [scotch-io/All-Github-Emoji-Icons](https://github.com/scotch-io/All-Github-Emoji-Icons) ⭐ 1,240 | 🐛 6 | 🌐 Shell | 📅 2022-07-15.
...
[![Diffable Maps](https://f.cloud.github.com/assets/282759/2090660/63f2e45a-8e97-11e3-9d8b-d4c8078b004e.gif)](https://github.com/benbalter/congressional-districts/commit/2233c76ca5bb059582d796f053775d8859198ec5) ⭐ 146 | 🐛 1 | 📅 2014-01-28
...
[Hub](https://github.com/github/hub) ⭐ 22,955 | 🐛 294 | 🌐 Go | 📅 2024-02-02 is a command line Git wrapper that gives you extra features and commands that make working with GitHub easier.
...
[*Check out some more cool commands Hub has to offer.*](https://github.com/github/hub#commands) ⭐ 22,955 | 🐛 294 | 🌐 Go | 📅 2024-02-02
...
*This can be aliased using the instructions found [here](https://github.com/tiimgreen/github-cheat-sheet#aliases) ⭐ 58,497 | 🐛 48 | 📅 2024-04-15.*
...
*Some Aliases are taken from [@mathiasbynens](https://github.com/mathiasbynens) dotfiles: <https://github.com/mathiasbynens/dotfiles/blob/master/.gitconfig> ⭐ 31,449 | 🐛 186 | 🌐 Shell | 📅 2024-08-05*
...
| Git God                                                | <https://github.com/gorosgobe/git-god> ⭐ 28 \| 🐛 0 \| 🌐 Ruby \| 📅 2018-09-05              |
| Git for Computer Scientists                            | <http://eagain.net/articles/git-for-computer-scientists/>                                    |
| Git Magic                                              | <http://www-cs-students.stanford.edu/~blynn/gitmagic/>                                       |
| Git Visualization Playground                           | <http://onlywei.github.io/explain-git-with-d3/#freeplay>                                     |
| Learn Git Branching                                    | <http://pcottle.github.io/learnGitBranching/>                                                |
| A collection of useful .gitignore templates            | <https://github.com/github/gitignore> ⭐ 175,286 \| 🐛 83 \| 📅 2026-07-23                    |
| Unixorn's git-extra-commands collection of git scripts | <https://github.com/unixorn/git-extra-commands> ⭐ 1,169 \| 🐛 2 \| 🌐 Shell \| 📅 2026-08-10 |
...
| Git Internals PluralSight           | <https://github.com/pluralsight/git-internals-pdf> ⚠️ Archived                      |
