...
GitHub uses [Linguist](https://github.com/github/linguist) ⭐ 13,645 | 🐛 226 | 🌐 Ruby | 📅 2026-08-18 to perform language detection and syntax highlighting. You can find out which keywords are valid by perusing the [languages YAML file](https://github.com/github/linguist/blob/master/lib/linguist/languages.yml) ⭐ 13,645 | 🐛 226 | 🌐 Ruby | 📅 2026-08-18.
...
*Some Aliases are taken from [@mathiasbynens](https://github.com/mathiasbynens) dotfiles: <https://github.com/mathiasbynens/dotfiles/blob/master/.gitconfig> ⭐ 31,455 | 🐛 186 | 🌐 Shell | 📅 2024-08-05*
